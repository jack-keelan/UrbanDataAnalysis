...
df.mod <- read.csv("data/TNG_metric_1sec.csv")
#df.mod <- read.csv("data/TNG_56Chand18_selectedbyMetric.csv")
df.mod$runID <- factor(df.mod$runID)
df.mod$SourceID <- factor(df.mod$SourceID)
...
mod <- readRDS("RF_56Chand18_selectedbyMetric_1sec_FULL_50per.rds")
rf.cv <- mod
...
# data_path <- "data/trainingData/144Ch_rolling/"
...
#data_path <- "data/trainingData/56Ch_rolling_3sec/"
data_path <- "data/trainingData/metric_rolling_1sec/"
...
saveRDS(rf.best, file="RF_56Chand18_selectedbyMetric_1sec_50per.rds")
saveRDS(rf.cv, file="RF_56Chand18_selectedbyMetric_1sec_FULL_50per.rds")
